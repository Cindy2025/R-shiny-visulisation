...
nodes=c("Linear Models"=1, "Danger Zone"=2, "Regularisation"=3, "Errors in Data"=4, "Data Cleaning"=5, "Distance Metrics"=6, "Dimensionality"=7, "Dimensional Reduction"=8, "Kernel Methods"=9, "Outliers"=10, "Life Cycle"=11, "Ethics"=12, "Paradigms"=13, "Visualisation"=14, "Robustness"=15)
...
label <-c("PCR", "elasticNet", "eased by", "a cause of", "mitigated by", "are fitted in", "mitigated by", "of", "exploits", "measured by", "cursed by","due to","blessed by", "mitigate", "exploit","suffer from","demands","part of")
